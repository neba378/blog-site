...
const Card = ({}) => {
  return (
    <>
      <div className="bottom flex flex-col justify-center items-center max-w-[388px] px-5 pt-5">
        <div className="right-section flex-1 flex justify-start items-center w-full max-h-[576px]">
          <Image
            src="/images/one.png"
            alt="Featured Image"
            width={608}
            height={576}
            className=" w-full rounded-[15px] h-[300px] mb-5 "
          />
        </div>
        <div className="description-box  items-start bg-white rounded-[15px] flex flex-1 flex-col gap-3 ">
          ...
          <div className="main-div gap-3 flex flex-col items-start justify-center  ">
